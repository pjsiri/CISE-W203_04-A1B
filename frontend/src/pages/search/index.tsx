...
const SearchPage = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>Search the SPEED Database</h1>
      <div className={styles.content}>
        <div className={styles.leftColumn}>
          <div className={styles.formGroup}>
          <h2 className={styles.searchTitle}>Enter Search Details</h2>
        ...
        <div className={styles.rightColumn}>
          <h2 className={styles.savedTitle}>Search Results</h2>
          <hr className={styles.hr}/>
          <p className={styles.sortInstructions}>Note: Click on the headings of the table (eg. Title) to sort the results. Click on a row in the table to show the summary.</p>
