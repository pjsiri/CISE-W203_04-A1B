...
export class ArticleController {
  ...
  async updateArticleSummary(
    @Param('id') id: string,
    @Body() updateData: { summary: string, claim: string, evidenceResult: string, researchType: string, participantType: string },
  ) {
    try {
      await this.articleService.updateSummary(id, updateData);
